...
public class Regex {
    ...
    public static final String REGEX_CONTRACT_ID = "^[C][T]-(\\d){4}$";
    public static final String REGEX_BOOKING_ID = "^[B][K]-(\\d){4}$";
    ...
    public static boolean getRegexContractId(String id) {
        return id.matches(REGEX_CONTRACT_ID);
    }

    public static boolean getRegexBookingID(String id) {
        return id.matches(REGEX_BOOKING_ID);
    }
